...
public final class WorldModel {
    ...
    public Optional<Entity> findNearest(Point pos, List<String> keys) {
    ...
    public void parseSapling(String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == Sapling.SAPLING_NUM_PROPERTIES) {
            ...
            Entity entity = new Sapling(id, pt, imageStore.getImageList(Sapling.SAPLING_KEY), 0, Sapling.SAPLING_KEY, Sapling.SAPLING_ACTION_ANIMATION_PERIOD, Sapling.SAPLING_ACTION_ANIMATION_PERIOD, health);
    ...
    public void parseDude(String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == Dude.DUDE_NUM_PROPERTIES) {
            Entity entity = new DudeNotFull(id, pt, imageStore.getImageList(Dude.DUDE_KEY), 0, Dude.DUDE_KEY, Double.parseDouble(properties[Dude.DUDE_ANIMATION_PERIOD]), Double.parseDouble(properties[Dude.DUDE_ACTION_PERIOD]), 0,
                    Integer.parseInt(properties[Dude.DUDE_LIMIT]), Dude.Dude_Strategy);
            this.tryAddEntity(entity);
        }else{
    ...
    public void parseFairy(String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == Fairy.FAIRY_NUM_PROPERTIES) {
            Entity entity = new Fairy(id, pt, imageStore.getImageList(Fairy.FAIRY_KEY), 0, Fairy.FAIRY_KEY, Double.parseDouble(properties[Fairy.FAIRY_ANIMATION_PERIOD]), Double.parseDouble(properties[Fairy.FAIRY_ACTION_PERIOD]), Fairy.Fairy_Strategy);
            this.tryAddEntity(entity);
        }else{
    ...
    public void parseTree(String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == Tree.TREE_NUM_PROPERTIES) {
            Entity entity = new Tree(id, pt, imageStore.getImageList(Tree.TREE_KEY), 0, Tree.TREE_KEY, Double.parseDouble(properties[Tree.TREE_ANIMATION_PERIOD]), Double.parseDouble(properties[Tree.TREE_ACTION_PERIOD]),
    ...
    public void parseObstacle(String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == Obstacle.OBSTACLE_NUM_PROPERTIES) {
            Entity entity = new Obstacle(id, pt, imageStore.getImageList(Obstacle.OBSTACLE_KEY), 0, Obstacle.OBSTACLE_KEY, Double.parseDouble(properties[Obstacle.OBSTACLE_ANIMATION_PERIOD]));
            this.tryAddEntity(entity);
        }else{
    ...
    public void parseHouse(String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == House.HOUSE_NUM_PROPERTIES) {
            Entity entity = new House(id, pt, imageStore.getImageList(House.HOUSE_KEY), 0, House.HOUSE_KEY);
            this.tryAddEntity(entity);
        }else{
    ...
    public void parseStump(String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == Stump.STUMP_NUM_PROPERTIES) {
            Entity entity = new Stump(id, pt, imageStore.getImageList(Stump.STUMP_KEY), 0, Stump.STUMP_KEY);
            this.tryAddEntity(entity);
        }else{
